      ...
      <BaseCard>
        ...
        <div class="space-y-4 px-4 py-3 text-sm">
          ...
          <p class="text-xs text-gray-500">
            ...
            で初回起動時に admin ユーザーが作成されます。DB にユーザーを登録すると管理画面とAPIにBasic認証がかかります(Webhookとヘルスチェックは除外)。
          </p>
          ...
          <form class="space-y-2" @submit.prevent="createUser">
            ...
            <div class="flex items-center justify-end gap-3">
              <span v-if="createUserSuccess" class="text-xs text-green-600">{{ createUserSuccess }}</span>
